...
/*   Updated: 2023/05/19 12:40:37 by tlegrand         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_init_game(t_game *game)
{
	...
	game->camera.y = 0;
	game->camera.z = 0.5;
	game->r_h = 2 * tan(FOV / 2) / game->mlx.win_width;
	game->r_v = 2 * tan(FOV * game->mlx.win_height / (game->mlx.win_width * 2)) / game->mlx.win_height;
